//! Ready-to-use question presets for common decision workflows. Ported from `laya/presets.py`.

use crate::Questions;
use serde_json::{json, Value};

fn to_questions(v: Value) -> Questions {
    match v {
...
/// `categories` overrides the default `category` choice options when provided.
pub fn email_questions(categories: Option<Value>) -> Questions {
